...
$slides = get_field( 'toolkits_slides', 'option' );
...
$resource_slides = have_rows( 'toolkits_slides', 'option' );
 ...
 * Arrow color
 */
$arrow_color = get_field( 'toolkits_arrow_color', 'option' );
$is_arrow_color = $arrow_color ? : '#fff';



if ( have_rows( 'toolkits_slides', 'option' ) ) :
	...
	<div class="slider-group">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<?php while ( have_rows( 'toolkits_slides', 'option' ) ) : the_row();
