...
add_action( 'init', 'infographics_create_post_type', 0 );
/**
 * Register custom post type
 */
function infographics_create_post_type() {

	$labels  = array(
		'name'                  => _x( 'Infographic', 'Post Type General Name', DD_MU_TEXT_DOMAIN ),
		'singular_name'         => _x( 'Infographic', 'Post Type Singular Name', DD_MU_TEXT_DOMAIN ),
		'menu_name'             => __( 'Infographics', DD_MU_TEXT_DOMAIN ),
		'name_admin_bar'        => __( 'Infographic', DD_MU_TEXT_DOMAIN ),
		...
		'featured_image'        => __( 'Infographic', DD_MU_TEXT_DOMAIN ),
		'set_featured_image'    => __( 'Set Infographic', DD_MU_TEXT_DOMAIN ),
		'remove_featured_image' => __( 'Remove Infographic', DD_MU_TEXT_DOMAIN ),
		'use_featured_image'    => __( 'Use as Infographic', DD_MU_TEXT_DOMAIN ),
